<template>
        ...
        <ul class="navbar-nav navbar-nav-right">
          ...
          <li class="nav-item nav-profile dropdown">
            <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" id="profileDropdown">
              ...
              <span class="nav-profile-name">软件工程</span>
            </a>
        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="pages/forms/basic_elements.html">
              ...
              <span class="menu-title">SQL查询</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" @click="goToNaturalSQL">
              <i class="mdi mdi-chart-pie menu-icon"></i>
              <span class="menu-title">自然语言查询</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" @click="goToVisualize">
              <i class="mdi mdi-grid-large menu-icon"></i>
              <span class="menu-title">结果可视化</span>
            </a>
          </li>
          <li class="nav-item">
      ...
      <div class="main-panel">
        ...
        <footer class="footer">
          <div class="d-sm-flex justify-content-center justify-content-sm-between">
            <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright &copy; 2019.Company name All rights reserved.<a target="_blank" href="https://www.downdemo.com/">&#x7F51;&#x9875;&#x6A21;&#x677F;</a></span>
  ...
  export default defineComponent({
    methods:{
      goToVisualize() {
      this.$router.push({ path: '/visualize' }); // 跳转到自然语言查询路径
      },
      goToHome() {
    ...
    data() {
      return {
        navItems: [
          ...
          { name: '个人数据库', link: '/database' },
          { name: '查询', link: '/query' },
          { name: '可视化图表展示', link: '/visualize' },
          { name: '个人信息编辑', link: '/profile' },
          { name: '消息回复', link: '/messages' }
        ]
      };
